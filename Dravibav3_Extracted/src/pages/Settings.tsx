    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {activeTab === 'backup' && (
            <div className="bg-white rounded-lg border border-border p-6">
              <h3 className="text-lg font-semibold text-foreground mb-4">Backup e Recuperação</h3>
              <p className="text-muted-foreground mb-4">Gerencie seus backups automáticos</p>
              <div className="space-y-4">
                <div className="p-4 bg-secondary rounded-lg">
                  <p className="text-sm font-medium text-foreground">Último backup: 26/03/2026 às 14:30</p>
                  <p className="text-xs text-muted-foreground mt-1">Próximo backup agendado para hoje às 23:00</p>
                </div>
