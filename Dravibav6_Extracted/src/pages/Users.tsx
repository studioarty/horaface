...
export default function Users() {
  ...
  const { users, createUser, updateUser, updateUserQuota, deleteUser, isUpdating, isCreating } = useUsers();
  ...
  const handleSaveUser = (userId: string | null, updates: any) => {
    if (userId) {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <UserManagementDialog
        ...
        isSaving={selectedUser ? isUpdating : isCreating}
      />
    </div>
  );
}
