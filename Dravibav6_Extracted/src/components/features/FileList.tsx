...
import { MoreVertical, Download, Share2, Trash2, Eye, Edit, Star, Tag, Clock } from 'lucide-react';
...
import FileVersionsDialog from '@/components/features/FileVersionsDialog';
...
export default function FileList({ files }: FileListProps) {
  ...
  const handleVersionsClick = (file: any) => {
