...
async function run() {
  console.log("Altering Supabase Database...");
  const { data, error } = await supabase.rpc('exec_sql', { sql_query: 'ALTER TABLE providers ADD COLUMN IF NOT EXISTS hourly_rate NUMERIC;' });
